...
node* deleteFromBST(node* &root, int val){
    ...
    if(root->data==val){
        ...
        // 1st type
        // if(root->right!=NULL && root->left!=NULL){
        //     minVal(root->right)->data means right wale part me se jo bhi root ayegi uska data
        ...
        // 2nd type
        if(root->right!=NULL && root->left!=NULL){
            // maxVal(root->left)->data means left wale part me se jo bhi root ayegi uska data
